...
anchors_demo <- tibble::tribble(
  ...
  "A1_OS_full", "Mentalidad de crecimiento (Outes & Sanchez, full)",        "Perú",         "PER",        -12.0464,    -77.0428,     7000,        TRUE,             "digital_education",     12,      14,      0.00,         NA,          NA,              0.054,    0.030,  "SD",         "attending",
  "A1_OS_reg",  "Mentalidad de crecimiento (Outes & Sanchez, regional)",    "Perú",         "PER",        -12.0464,    -77.0428,     7000,        TRUE,             "digital_education",     12,      14,      0.00,         NA,          NA,              0.135,    0.051,  "SD",         "attending",
  "A1b_Porter", "Mentalidad de crecimiento (Porter et al.)",                "Sudáfrica",    "ZAF",        -25.7479,     28.2293,     6500,        FALSE,            "digital_education",     13,      16,      0.00,         10.02,       NA,              -0.04,    0.10,   "SD",         "attending",
  ...
  "A3_Irumi",   "Irûmi — pensamiento computacional (Näslund-Hadley)",       "Paraguay",     "PRY",        -25.2637,    -57.5759,     5800,        TRUE,             "digital_education",      7,       8,      NA,           0.00,        NA,              0.089,    0.052,  "SD",         "hh_computer",
  "A6_caut",    "Plan Ceibal SOLO HARDWARE (De Melo)",                      "Uruguay",      "URY",        -34.9011,    -56.1645,    20800,        TRUE,             "digital_education",      8,      12,      NA,           0.00,        NA,              0.00,     0.05,   "SD",         "hh_computer",
  "A6_ped",     "Plan Ceibal + programación (Gómez-Ruiz)",                  "Uruguay",      "URY",        -34.9011,    -56.1645,    20800,        TRUE,             "digital_education",     14,      17,      NA,           NA,          NA,              0.13,     0.05,   "SD",         "attending",
