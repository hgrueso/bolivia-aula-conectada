...
anchors_demo <- tibble::tribble(
  ...
  "A0_EY",      "Girls' education meta-analysis (Evans & Yuan 2022)",       "LMIC (pooled)","BOL",        -16.2902,    -63.5887,     3600,        TRUE,             "digital_education",     10,      19,      0.30,         NA,          NA,              0.07,     0.025,  "SD",         "attending",
